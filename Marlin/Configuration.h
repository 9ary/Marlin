...
#define STRING_CONFIG_H_AUTHOR "(novenary, Ender-9)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-9"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 19, -24.8, -4.18 }
...
#define MANUAL_Z_HOME_POS -0.0916
